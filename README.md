...
|-----------------|------------|----------------------------------------------|----------------------------------------|------------------------|--------------------------------|--------|------|-------|
| NEW202006221301 | shine网上书城  | https://gitee.com/thuihuang/shine_bookshop | html+css+JavaScript、Jquery、BootStrap | Jsp、Servlet、jdbc、mysql | [JSP+Servlet+JDBC实现的shine网上书城](newcomer/JSP+Servlet+JDBC实现的shine网上书城.md) | [JSP+Servlet+JDBC实现的shine网上书城](https://www.zhihu.com/people/zhangcaoran/posts?page=2)   |      |       |
