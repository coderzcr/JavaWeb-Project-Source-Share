...
|-----------------|------------|----------------------------------------------|----------------------------------------|------------------------|--------------------------------|--------|------|-------|
| NEW202006221301 | shine网上书城  | [shine网上书城](https://gitee.com/thuihuang/shine_bookshop) | html+css+JavaScript、Jquery、BootStrap | Jsp、Servlet、jdbc、mysql | [shine网上书城](newcomer/JSP+Servlet+JDBC实现的shine网上书城.md) | [shine网上书城](https://www.zhihu.com/people/zhangcaoran/posts?page=2)   |      |       |
